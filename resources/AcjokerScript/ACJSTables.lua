...
Pedlistname = {
    {T('Special Peds') , T('Changes Peds to One of the Custom Peds')},
    {T('Ambient Male NPCs'), T('Changes Peds to Ambient Males')},
    {T('Ambient Female NPCs'), T('Changes Peds to Ambient Females')},
    {T('Cutscene Peds'), T('Changes Peds to Cutscene Peds(dont usually speak)')},
    {T('Gang Members'), T('Changes Peds to Gang Members')},
    {T('Multiplayer Peds'), T('Changes Peds to Multiplayer Peds')},
    {T('Multiplayer Scenario Females'), T('Changes Peds to Multiplayer Scenario Females')},
    {T('Multiplayer Scenario Males'), T('Changes Peds to Multiplayer Scenario Males')},
    {T('Story Mode Characters'), T('Changes Peds to Story Mode Characters')},
    {T('Story Scenario Females'), T('Changes Peds to Story Scenario Females')},
    {T('Story Scenario Males'), T('Changes Peds to Story Scenario Males')},
    {T('DLC Peds'), T('Changes Peds to Peds from the DLCs')}
}
...
Exlist = {
    T('Grenade'), --modified list from jerryscript
    T('Grenade Launcher'),
    T('Sticky Bomb'),
    T('Molotov'),
    T('Rocket'),
    ...
    T('Truck'),
    T('Bullet'),
    T('Smoke Grenade Launcher (adjust delay to start)'),
    T('Smoke Grenade (adjust delay to start)'),
    T('BZ Gas'),
    T('Flare'),
    T('Gas Canister'),
    T('Fire Extinguisher'),
    ...
    T('Proximity Mine'),
    T('Valkyrie Cannon'),
    T('Air Defence (can not be seen outside of water)'),
    T('Pipe Bomb'),
    T('Vehicle Mine'),
    T('Explosive Ammo'),
    T('APC Shell'),
    T('Bomb Cluster'),
    T('Bomb Gas (can not be seen)'),
    T('Bomb Incendiary'),
    T('Bomb Standard'),
    T('Torpedo'),
    T('Torpedo Underwater (Use this if they are in the water)'),
    T('Bombushka Cannon'),
    ...
    T('Rogue Cannon'),
    T('Mine Underwater'),
    T('Orbital Cannon (can not be seen outside of water)'),
    T('Bomb Standard Wide'),
    T('Explosive Ammo Shotgun'),
    T('Oppressor MK2 Cannon'),
    T('Mortar Kinetic'),
    T('Vehicle Mine Kinetic'),
    T('Vehicle Mine EMP'),
    T('Vehicle Mine Spike'),
    T('Vehicle Mine Slick'),
    T('Vehicle Mine Tar'),
    T('Script drone'),
    T('Up-n-Atomizer'),
    T('Buried Mine'),
    T('Script Missile'),
    T('RC Tank Rocket'),
    T('Bomb Water (can not be seen outside of water)'),
    T('Bomb Water Secondary (can not be seen outside of water)'),
    T('Stun Grenade Alt'),
    T('Stun Grenade Alt 2'),
    T('Flash Grenade'),
    T('Stun Grenade'),
    T('Stun Grenade Alt 3'),
...
Fxcorelist = {
    ...
    T("Flashbang"),
    T("Gobstoppers"),
    T("Blood(Turn them into Carrie)"),
    T("Metal Fragment"),
    T("Water"),
    T("Oil(will start glitching out)"),
    T("Paparazzi Flash"),
    T("Gasoline Pump Explosion"),
    T("Molotov"),
    T("Cig Exhale(Chain Smoker)"),
    T("Wood"),
    T("Electrical Fire"),
    T("Water Splash"),
    T("Polystyrene"),
    ...
    T("Flying Cigarettes"),
    T("Rain Oranges"),
    T("Vehicle Respray Smoke(Very Laggy)"),
    T("Sparking Wires"),
    T("Sub Large Explosion"),
    T("Dust(Turn them into Pig-Pen)"),
    T("Show them they are TRASH"),
    T("Extinguisher(Very Laggy)"),
    T("Splash Pee"),
    T("Bubbles Everywhere"),
    T("Water Mist(Very Laggy)"),
    T("Coins"),
    T("Foundry Steam"),
    T("Mail"),
    T("XS Ray"),
    T("Extinguisher Water(starts glitching)"),
    T("Smoke Grenade"),
    T("Telegraph Pole"),
    T("Launched Emp"),
    T("Electrical Box"),
